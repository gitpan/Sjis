...
if ("アソア" =~ /(ア([イソウ])ア)/) {
    if ($1 eq "アソア") {
        if ($2 eq "ソ") {
            ...
            print qq{not ok - 5a "アソア" =~ /(ア([イソウ])ア)/ \$1=($1), \$2=($2) $^X $__FILE__\n};
        }
    }
    else {
        print qq{not ok - 5b "アソア" =~ /(ア([イソウ])ア)/ \$1=($1), \$2=($2) $^X $__FILE__\n};
    }
}
else {
    print qq{not ok - 5c "アソア" =~ /(ア([イソウ])ア)/ \$1=($1), \$2=($2) $^X $__FILE__\n};
}
...
if ("アソソ" =~ /(アソ+)/) {
    ...
    print qq{not ok - 14 "アソソ" =~ /(アソ+)/ \$1=($1) $^X $__FILE__\n};
}
