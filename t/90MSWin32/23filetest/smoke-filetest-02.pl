...
if (((-r 'file') ne '') == ((-r 'F機能') ne '')) {
    print "ok - -r 'file' == -r 'F機能' $^X $__FILE__\n";
}
else {
    print "not ok - -r 'file' == -r 'F機能' $^X $__FILE__\n";
}
...
if (((-w 'file') ne '') == ((-w 'F機能') ne '')) {
    print "ok - -w 'file' == -w 'F機能' $^X $__FILE__\n";
}
else {
    print "not ok - -w 'file' == -w 'F機能' $^X $__FILE__\n";
}
...
if (((-x 'file') ne '') == ((-x 'F機能') ne '')) {
    print "ok - -x 'file' == -x 'F機能' $^X $__FILE__\n";
}
else {
    print "not ok - -x 'file' == -x 'F機能' $^X $__FILE__\n";
}
...
if (((-o 'file') ne '') == ((-o 'F機能') ne '')) {
    print "ok - -o 'file' == -o 'F機能' $^X $__FILE__\n";
}
else {
    print "not ok - -o 'file' == -o 'F機能' $^X $__FILE__\n";
}
...
if (((-e 'file') ne '') == ((-e 'F機能') ne '')) {
    print "ok - -e 'file' == -e 'F機能' $^X $__FILE__\n";
}
else {
    print "not ok - -e 'file' == -e 'F機能' $^X $__FILE__\n";
}
...
if (((-z 'file') ne '') == ((-z 'F機能') ne '')) {
    print "ok - -z 'file' == -z 'F機能' $^X $__FILE__\n";
}
else {
    print "not ok - -z 'file' == -z 'F機能' $^X $__FILE__\n";
}
...
if (((-s 'file') ne '') == ((-s 'F機能') ne '')) {
    print "ok - -s 'file' == -s 'F機能' $^X $__FILE__\n";
}
else {
    print "not ok - -s 'file' == -s 'F機能' $^X $__FILE__\n";
}
...
if (((-f 'file') ne '') == ((-f 'F機能') ne '')) {
    print "ok - -f 'file' == -f 'F機能' $^X $__FILE__\n";
}
else {
    print "not ok - -f 'file' == -f 'F機能' $^X $__FILE__\n";
}
...
if (((-d 'file') ne '') == ((-d 'F機能') ne '')) {
    print "ok - -d 'file' == -d 'F機能' $^X $__FILE__\n";
}
else {
    print "not ok - -d 'file' == -d 'F機能' $^X $__FILE__\n";
}
...
if (((-p 'file') ne '') == ((-p 'F機能') ne '')) {
    print "ok - -p 'file' == -p 'F機能' $^X $__FILE__\n";
}
else {
    print "not ok - -p 'file' == -p 'F機能' $^X $__FILE__\n";
}
...
if (((-b 'file') ne '') == ((-b 'F機能') ne '')) {
    print "ok - -b 'file' == -b 'F機能' $^X $__FILE__\n";
}
else {
    print "not ok - -b 'file' == -b 'F機能' $^X $__FILE__\n";
}
...
if (((-c 'file') ne '') == ((-c 'F機能') ne '')) {
    print "ok - -c 'file' == -c 'F機能' $^X $__FILE__\n";
}
else {
    print "not ok - -c 'file' == -c 'F機能' $^X $__FILE__\n";
}
...
if (((-t 'file') ne '') == ((-t 'F機能') ne '')) {
    print "ok - -t 'file' == -t 'F機能' $^X $__FILE__\n";
}
else {
    print "not ok - -t 'file' == -t 'F機能' $^X $__FILE__\n";
}
...
if (((-u 'file') ne '') == ((-u 'F機能') ne '')) {
    print "ok - -u 'file' == -u 'F機能' $^X $__FILE__\n";
}
else {
    print "not ok - -u 'file' == -u 'F機能' $^X $__FILE__\n";
}
...
if (((-g 'file') ne '') == ((-g 'F機能') ne '')) {
    print "ok - -g 'file' == -g 'F機能' $^X $__FILE__\n";
}
else {
    print "not ok - -g 'file' == -g 'F機能' $^X $__FILE__\n";
}
...
if (((-k 'file') ne '') == ((-k 'F機能') ne '')) {
    print "ok - -k 'file' == -k 'F機能' $^X $__FILE__\n";
}
else {
    print "not ok - -k 'file' == -k 'F機能' $^X $__FILE__\n";
}
...
if (((-M 'file') ne '') == ((-M 'F機能') ne '')) {
    print "ok - -M 'file' == -M 'F機能' $^X $__FILE__\n";
}
else {
    print "not ok - -M 'file' == -M 'F機能' $^X $__FILE__\n";
}
...
if (((-A 'file') ne '') == ((-A 'F機能') ne '')) {
    print "ok - -A 'file' == -A 'F機能' $^X $__FILE__\n";
}
else {
    print "not ok - -A 'file' == -A 'F機能' $^X $__FILE__\n";
}
