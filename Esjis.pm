...
When esjis.pl converts your script, "use Esjis;" is automatically output.
...
And the <no Esjis> is not supported and B<use Esjis> can appear as many
...
=item Make ignore character case string
