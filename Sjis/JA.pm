...
=head1 ƒCƒ“ƒXƒg[ƒ‹•û–@
   ...
   perl64  make.bat install --- perl64    ŠÂ‹«‚ÉƒCƒ“ƒXƒg[ƒ‹‚µ‚Ü‚·
...
=head1 ƒ\ƒtƒgƒEƒFƒA‚Ìˆê——
   ...
   perl64.bat       --- ŠÂ‹«•Ï” PATH ‚ÌÝ’è‚È‚µ‚É perl64   ‚ð’T‚µ‚ÄŽÀs‚·‚é
...
“¯—l‚É \b ‚Æ \B ‚à‰ß‹Ž‚Ìperl‚Æ‚ÌŒÝŠ·«‚ð•Û‚Â‚½‚ß‚ÉÄ’è‹`‚³‚ê‚Ä‚¢‚Ü‚·B
...
=item * chdir
    ...
    MSWin32 ŠÂ‹«‚Ì perl5.006, perl5.008, perl5.010, perl5.012 ‚É‚Ä•¶ŽšƒR[ƒh(0x5C)
    ‚ÅI‚í‚éƒpƒX‚ðˆµ‚¤‚±‚Æ‚ª‚Å‚«‚Ü‚¹‚ñB
...
=item * m/$re/o, s/$re/foo/o, qr/$re/o ‚Ì /o CüŽq
    ...
    •ÏX‚³‚ê‚é‚ÆŽŸ‰ñ‚ÌŽÀsŽž‚É‚»‚Ì•ÏX‚ª”½‰f‚³‚ê‚Ü‚·B‚Å‚à /o ‚ðŽg‚¤‚Æ‚«‚Í $re
    ‚Ì“à—e‚ð•ÏX‚µ‚È‚¢‚Å‚µ‚å‚¤‚©‚çAŽÀÛ‚É–â‘è‚É‚È‚é‚±‚Æ‚Í‚È‚¢‚Å‚µ‚å‚¤B

=item * “ÁŽê•Ï” $` ‚Æ $& ‚Í‹@”\‚µ‚Ü‚¹‚ñ

    ‚È‚º‚È‚ç‚ÎA
 
      'AAABBBCCC' =~ /BBB/;
 
    ‚Æ‚¢‚¤ƒXƒNƒŠƒvƒg‚ðƒXƒP[ƒv‚·‚é‚Æ³‹K•\Œ»‚Ìæ“ª‚Éƒ}ƒ‹ƒ`ƒoƒCƒgƒAƒ“ƒJ[ƒŠƒ“ƒO
    ˆ—‚Ì‚½‚ß‚Ì‹Lq‚ª’Ç‰Á‚³‚êA
 
      'AAABBBCCC' =~ /\G(?:[\x81-\x9F\xE0-\xFC][\x00-\xFF]|[^\x81-\x9F\xE0-\xFC])*?(?:BBB)@Esjis::m_matched/;
 
    ‚»‚Ì•”•ª‚à $& ‚ÉŠÜ‚Ü‚ê‚Ä‚µ‚Ü‚¤‚©‚ç‚Å‚·B
    ã‹L‚ÌŽÀsŒ‹‰Ê‚ÍˆÈ‰º‚Ì‚æ‚¤‚É‚È‚è‚Ü‚·B 
      $' ‚Í ''       ('AAA' ‚ðŠó–])
      $& ‚Í 'AAABBB' ('BBB' ‚ðŠó–])
      $` ‚Í 'CCC'
    ...
    ‚Ì‚æ‚¤‚É‚µ‚ÄA³‹K•\Œ»‘S‘Ì‚ð ( ... ) ‚ÅˆÍ‚ñ‚ÅƒLƒƒƒvƒ`ƒƒ‚µ‚Ü‚·B
    ƒGƒXƒP[ƒvŒã‚ÌƒXƒNƒŠƒvƒg‚Í
 
      'AAABBBCCC' =~ /\G(?:[\x81-\x9F\xE0-\xFC][\x00-\xFF]|[^\x81-\x9F\xE0-\xFC])*?(?:(BBB))@Esjis::m_matched/;
 
    ‚Ì‚æ‚¤‚É‚È‚é‚Ì‚ÅAŽÀsŒãA
 
      $1 ‚Í 'BBB'
 
    ‚É‚È‚èA$& ‚Ì‘ã‚í‚è‚ÉŽg—p‚·‚é‚±‚Æ‚ª‚Å‚«‚Ü‚·B
...
=item * ƒS[ƒ‹4
    ...
    JPerl ‚Í Perl Œ¾Œê‚ð•ªŠò‚³‚¹‚È‚¢‚æ‚¤‚É‚·‚é‚½‚ß‚ÉAƒCƒ“ƒ^ƒvƒŠƒ^‚ð•ªŠò‚³‚¹‚Ü‚µ‚½B
    ‚Å‚à Perl ƒRƒAƒ`[ƒ€‚ÍƒCƒ“ƒ^ƒvƒŠƒ^‚Ì•ªŠò‚ð–]‚ñ‚Å‚¢‚È‚¢‚Ì‚Å‚µ‚å‚¤B
    ...
    ‚»‚ê‚É–â‘è‚ð perl ƒXƒNƒŠƒvƒg‚Å‰ðŒˆ‚·‚é‚È‚çAPerl ƒRƒ~ƒ…ƒjƒeƒB‚ªƒTƒ|[ƒg‚µ‚Ä
    ‚­‚ê‚é‚±‚Æ‚Å‚µ‚å‚¤B
