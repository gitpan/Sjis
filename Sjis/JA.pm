...
‚±‚Ì•¶‘‚Å‚Í‚±‚ê‚ç‚Ì‘Ì‚µ‚Ä ShiftJIS ‚Æ‚¢‚¤Œê‚Å•\‚µ‚Ä‚¢‚Ü‚·(u_v‚ª‚È‚¢)B

•¡G‚È‰ğ–@‚Í–â‘è‚ğ‚æ‚è•¡G‚É‚µ‚Ü‚·B
...
=head1 ƒCƒ“ƒXƒg[ƒ‹•û–@(make‚ğg‚¤ê‡)
   ...
   ‚à‚µƒVƒXƒeƒ€‚É strict.pm ‚ª‚È‚¢ê‡‚Í•t‘®‚Ì strict.pm_ ‚ğ strict.pm ‚ÉƒŠƒl[ƒ€
   ‚µ‚Äg—p‚µ‚Ä‚­‚¾‚³‚¢B
...
‚±‚ÌƒAƒvƒ[ƒ`‚ÍAŒã‘Ş‚ªŒˆ‚µ‚Ä‹–‚³‚ê‚È‚¢•ª–ì‚É—LŒø‚Å‚·B
...
=head1 perl5.005 ‚É‚æ‚é Perl5.6 ƒGƒ~ƒ…ƒŒ[ƒVƒ‡ƒ“
  ...
  perl5.005 ‚ğ—˜—p‚µ‚Ä‚¢‚éÛ‚É Perl5.6 ‚ÌŠÖ”‚Ì“®ì‚ğƒGƒ~ƒ…ƒŒ[ƒg‚µ‚Ü‚·B

  --------------------------------------------------------------------
  ˆ—‘O          ˆ—Œã                 Esjis.pm ‚Ì BEGIN { } ‚Åİ’è
  --------------------------------------------------------------------
  binmode(...);   Esjis::binmode(...);   *CORE::GLOBAL::binmode = ...
  open(...);      Esjis::open(...);      *CORE::GLOBAL::open    = ...
  --------------------------------------------------------------------

=head1 –³‹‚·‚é utf8 ƒvƒ‰ƒOƒ}
  ...
  ˆ—‘O          ˆ—Œã                 à–¾
  ---------------------------------------------------------------------
  use utf8;       # use utf8;            Esjis.pm ‚Í no utf8; ‚³‚ê‚Ä‚¢‚é
  no utf8;        # no utf8;             ‚Æ‚«‚à utf8::* ŠÖ”‚ğ’ñ‹Ÿ‚µ‚Ü‚·
  use bytes;      # use bytes;           Esjis.pm ‚Í no bytes; ‚³‚ê‚Ä‚¢‚é
  no bytes;       # no bytes;            ‚Æ‚«‚à bytes::* ŠÖ”‚ğ’ñ‹Ÿ‚µ‚Ü‚·
  ---------------------------------------------------------------------

=over 2

=item binmode (perl5.005 ‚É‚æ‚é Perl5.6 ƒGƒ~ƒ…ƒŒ[ƒVƒ‡ƒ“)
  ...
  * 2 ‚Â‚Ìˆø”‚ªg‚¦‚Ü‚·
  ...
  perl5.005 ã‚ÅÀs‚µ‚½ê‡‚ÍAPerl5.6 ‚Ì binmode ŠÖ”‚Ì‹@”\‚ğƒGƒ~ƒ…ƒŒ[ƒg‚µ‚Ü‚·B
  ˆÈ‰º‚Í—v“_‚Ì‚İ‚Ì‹Lq‚È‚Ì‚ÅAÚ×‚Í perlfunc/binmode ‚ğQÆ‚µ‚Ä‚­‚¾‚³‚¢B

   ƒtƒ@ƒCƒ‹ƒnƒ“ƒhƒ‹ FILEHANDLE ‚É‘Î‚µ‚ÄA$disciplines ˆø”‚Åw’è‚³‚ê‚½ˆµ‚¢‚ğs‚¤‚æ
  ‚¤‚É‚·‚éB$disciplines ‚ğÈ—ª‚·‚é‚ÆAƒtƒ@ƒCƒ‹ƒnƒ“ƒhƒ‹‚ğ ':raw' ‚Æ‚µ‚Äˆµ‚¤‚æ‚¤‚É
  ‚·‚éBFILEHANDLE ‚ª®‚¾‚Á‚½ê‡A‚»‚Ì’l‚ªƒtƒ@ƒCƒ‹ƒnƒ“ƒhƒ‹‚Ì–¼‘O‚Ü‚½‚Íƒtƒ@ƒCƒ‹ƒnƒ“
  ƒhƒ‹‚Ö‚ÌƒŠƒtƒ@ƒŒƒ“ƒX‚Æ‚µ‚Äˆµ‚í‚ê‚éB

   binmode ŠÖ”‚ÍAƒtƒ@ƒCƒ‹‚ğ open ‚µ‚Ä‚©‚çA‚»‚Ìƒtƒ@ƒCƒ‹ƒnƒ“ƒhƒ‹‚É‘Î‚µ‚ÄÀÛ‚Ì I/O
  ‘€ì‚ğs‚¤‚Ü‚Å‚ÌŠÔ‚ÉAÀs‚µ‚È‚¯‚ê‚Î‚È‚ç‚È‚¢B‚³‚Ü‚´‚Ü‚Èƒ‚[ƒh‚ªAƒoƒbƒtƒ@“à‚Ì‚³
  ‚Ü‚´‚Ü‚Èƒf[ƒ^‚É‘Î‚µ‚ÄA‚³‚Ü‚´‚Ü‚È‰ÁH‚ğs‚¤‚½‚ß‚ÉAƒtƒ@ƒCƒ‹‚Ìƒ‚[ƒh‚ğƒŠƒZƒbƒg‚·
  ‚é‚É‚ÍA‚»‚Ìƒtƒ@ƒCƒ‹‚ğƒI[ƒvƒ“‚µ‚È‚¨‚·ˆÈŠO‚É•û–@‚Í‚È‚¢B

   ":raw" ƒfƒBƒVƒvƒŠƒ“‚ÍAPerl ‚ªƒf[ƒ^‚Ì’†g‚Éèo‚µ‚µ‚È‚¢‚æ‚¤‚É‚·‚é‚½‚ß‚Ì‚à‚Ì‚Å‚ 
  ‚éBŠeƒfƒBƒVƒvƒŠƒ“‚ª‚Ç‚Ì‚æ‚¤‚É“®ì‚·‚é‚©‚É‚Â‚¢‚Ä‚Í open ŠÖ”‚Ì€‚ğQÆ‚µ‚Ä‚­‚¾
  ‚³‚¢B

=item open (perl5.005 ‚É‚æ‚é Perl5.6 ƒGƒ~ƒ…ƒŒ[ƒVƒ‡ƒ“)
  ...
  * ƒtƒ@ƒCƒ‹ƒnƒ“ƒhƒ‹‚ğ©“®¶¬(autovivification)‚µ‚Ü‚·
  * 3 ‚Â‚Ìˆø”‚ªg‚¦‚Ü‚·

  perl5.005 ã‚ÅÀs‚µ‚½ê‡‚ÍAPerl5.6 ‚Ì open ŠÖ”‚Ì‹@”\‚ğƒGƒ~ƒ…ƒŒ[ƒg‚µ‚Ü‚·B
  ˆÈ‰º‚Í—v“_‚Ì‚İ‚Ì‹Lq‚È‚Ì‚ÅAÚ×‚Í perlfunc/open ‚ğQÆ‚µ‚Ä‚­‚¾‚³‚¢B

   ‚±‚Ì—á‚ª¦‚·‚æ‚¤‚ÉA‚½‚¢‚Ä‚¢‚Ìê‡AFILEHANDLE ˆø”‚Í’Pƒ‚È¯•Êq(•’Ê‚Í‘å•¶š
  ‚Ì‚İ‚©‚ç¬‚é)‚Å‚ ‚é‚ªA‚»‚Ì’l‚ªƒtƒ@ƒCƒ‹ƒnƒ“ƒhƒ‹‚Ö‚ÌƒŠƒtƒ@ƒŒƒ“ƒX‚É‚È‚é‚æ‚¤‚È®‚ğ
  w’è‚·‚é‚±‚Æ‚à‚Å‚«‚éB(‚±‚ÌƒŠƒtƒ@ƒŒƒ“ƒX‚É‚ÍAƒtƒ@ƒCƒ‹ƒnƒ“ƒhƒ‹–¼‚É‘Î‚·‚éƒVƒ“ƒ{
  ƒŠƒbƒNƒŠƒtƒ@ƒŒƒ“ƒXA‚Ü‚½‚Íƒtƒ@ƒCƒ‹ƒnƒ“ƒhƒ‹‚Æ‰ğß‚Å‚«‚é”CˆÓ‚ÌƒIƒuƒWƒFƒNƒg‚Ö‚Ì
  ƒn[ƒhƒŠƒtƒ@ƒŒƒ“ƒX‚ğw’è‚Å‚«‚éB)‚±‚ê‚ÍŠÔÚƒtƒ@ƒCƒ‹ƒnƒ“ƒhƒ‹(indirect filehandle)
  ‚ÆŒÄ‚Î‚ê‚éB‘æ1ˆø”‚Æ‚µ‚Ä FILEHANDLE ‚ğó‚¯æ‚é‚·‚×‚Ä‚ÌŠÖ”‚ÍAƒtƒ@ƒCƒ‹ƒnƒ“ƒhƒ‹
  ‚Ì‘ã‚í‚è‚ÉAŠÔÚƒtƒ@ƒCƒ‹ƒnƒ“ƒhƒ‹‚ğó‚¯æ‚é‚±‚Æ‚ª‚Å‚«‚éB‚µ‚©‚µ open ‚Ìê‡‚Í“Á•Ê
  ‚ÅAŠÔÚƒtƒ@ƒCƒ‹ƒnƒ“ƒhƒ‹‚Æ‚µ‚Ä–¢’è‹`‚Ì•Ï”‚ğw’è‚·‚é‚ÆAPerl ‚Í©“®“I‚É‚»‚Ì•Ï”
  ‚ğ’è‹`‚µ‚ÄA©“®¶¬‚É‚æ‚Á‚ÄA“KØ‚Èƒtƒ@ƒCƒ‹ƒnƒ“ƒhƒ‹‚Ö‚ÌƒŠƒtƒ@ƒŒƒ“ƒX‚ğƒZƒbƒg‚µ‚Ä
  ‚­‚ê‚éB‚±‚Ì—˜“_‚Ì1‚Â‚Æ‚µ‚Ä‚ÍAƒtƒ@ƒCƒ‹ƒnƒ“ƒhƒ‹‚ª‚Ç‚±‚©‚ç‚àQÆ‚³‚ê‚È‚­‚È‚é(“TŒ^
  “I‚É‚ÍA‚»‚Ì•Ï”‚ÌƒXƒR[ƒv‚©‚ç”²‚¯o‚µ‚½ê‡)‚ÆA©“®“I‚ÉƒNƒ[ƒY‚³‚ê‚é‚Æ‚¢‚¤‚±‚Æ
  ‚ª‹“‚°‚ç‚ê‚éB

  {
      my $fh;                   # (‰Šú‰»‚µ‚Ä‚¢‚È‚¢)
      open($fh, ">logfile")     # $fh ‚Í©“®¶¬‚³‚ê‚é
          or die "Can't create logfile: $!";
          ...                   # $fh ‚ğg‚Á‚Äˆ—‚ğs‚¤
  }                             # $fh ‚Í‚±‚±‚ÅƒNƒ[ƒY‚³‚ê‚é

  ‚Ü‚½AŸ‚Ì‚æ‚¤‚É‚µ‚ÄAopen ŠÖ”‚ğŒÄ‚Ño‚·Û‚É my $fh éŒ¾‚ğs‚¦‚ÎA‚³‚ç‚É“Ç‚İ‚â‚·
  ‚­‚È‚é:

  open my $fh, ">logfile" or die ...

   ‚±‚±‚ÅAƒtƒ@ƒCƒ‹–¼‚Ìæ“ª‚É‚ ‚é ">" ‚ÍAƒ‚[ƒh‚Ìˆê—á‚Å‚ ‚éB—ğj“I‚È˜b‚ğ‚·‚é‚ÆAÅ
  ‰‚É—pˆÓ‚³‚ê‚½ open ‚Í2ˆø”‚Ì‚à‚Ì‚Å‚ ‚Á‚½BÅ‹ßA“±“ü‚³‚ê‚½3ˆø”‚Ì open ‚Å‚ÍAƒ‚[
  ƒh‚ğƒtƒ@ƒCƒ‹–¼‚©‚ç“Æ—§‚µ‚Ä•ÊŒÂ‚Éw’è‚Å‚«‚é‚Ì‚ÅA‚±‚ê‚ç‚ª¬“¯‚³‚ê‚é‚±‚Æ‚ª‚È‚¢‚Æ‚¢‚¤
  —˜“_‚ª‚ ‚éB—á‚¦‚ÎAŸ‚É¦‚·ƒR[ƒh‚Å‚ÍA">" ‚Ån‚Ü‚é–¼‘O‚ğ‚Âƒtƒ@ƒCƒ‹‚ğƒI[ƒvƒ“
  ‚·‚é‚í‚¯‚Å‚Í‚È‚¢‚±‚Æ‚ª‚í‚©‚éB‚±‚ÌƒR[ƒh‚Å‚ÍA$mode ‚Æ‚µ‚Ä ">" ‚ªw’è‚³‚ê‚Ä‚¢‚é‚Ì
  ‚ÅA$expr ‚Åw’è‚³‚ê‚½–¼‘O‚ğ‚Âƒtƒ@ƒCƒ‹‚ğ‘‚«‚İ—p‚ÉƒI[ƒvƒ“‚µ‚æ‚¤‚Æ‚·‚éB
  ‚»‚ÌÛ‚ÉA‚à‚µƒtƒ@ƒCƒ‹‚ª‘¶İ‚µ‚È‚¯‚ê‚ÎV‚½‚Éì¬‚µA‚·‚Å‚Éƒtƒ@ƒCƒ‹‚ª‘¶İ‚·‚ê‚ÎA
  ‚»‚Ìƒtƒ@ƒCƒ‹‚ğØ‚èÌ‚Ä‚Ä‹ó‚É‚·‚é:
  
  open(LOG, ">", "logfile")  or die "Can't create logfile: $!";

   1ˆø”‚Æ2ˆø”‚Ì open ‚Å‚ÍA•¶š—ñ•Ï”‚ğƒtƒ@ƒCƒ‹–¼‚Æ‚µ‚Äg‚¤Û‚É‚Í’ˆÓ‚ª•K—v‚Å‚ ‚éB
  ‚È‚º‚È‚çA•Ï”‚Í“¾‘Ì‚Ì’m‚ê‚È‚¢‚ ‚ç‚ä‚é•¶š‚ğŠÜ‚ñ‚Å‚¢‚é‰Â”\«‚ª‚ ‚é‚©‚ç‚¾(“Á‚ÉAƒC
  ƒ“ƒ^[ƒlƒbƒg‚Ì“¾‘Ì‚Ì’m‚ê‚È‚¢ƒ†[ƒU‚©‚çƒtƒ@ƒCƒ‹–¼‚ğó‚¯æ‚éê‡)B\•ª‚É’ˆÓ‚µ‚È‚¢
  ‚ÆAƒtƒ@ƒCƒ‹–¼‚Ìˆê•”‚ªA$mode •¶š—ñA–³‹‚³‚ê‚é‹ó”’•¶šAdup w’èq(>& ‚È‚Ç)A
  ƒ}ƒCƒiƒX "-" ‚Æ‰ğß‚³‚ê‚Ä‚µ‚Ü‚¤‰Â”\«‚ª‚ ‚éBŸ‚É¦‚·‚Ì‚ÍA‚±‚Ìƒgƒ‰ƒuƒ‹‚ğ”ğ‚¯‚é‚½
  ‚ß‚ÉA“`““I‚És‚í‚ê‚Ä‚«‚½‚â‚è•û‚Ì1‚Â‚Å‚ ‚éB

  $path =~ s#^([ ])#./$1#;
  open (FH, "< $path\0") or die "can't open $path: $!";

   ‚µ‚©‚µA‚±‚ê‚É‚à‚Ü‚¾‚¢‚­‚Â‚©–â‘è‚ª‚ ‚éB‘ã‚í‚è‚ÉA3ˆø”‚Ì open ‚ğg‚¤‚æ‚¤‚É‚·‚ê
  ‚ÎAƒZƒLƒ…ƒŠƒeƒBã‚ÌƒŠƒXƒN‚É‚³‚ç‚³‚ê‚¸‚ÉA”CˆÓ‚Ìƒtƒ@ƒCƒ‹–¼‚ğAƒNƒŠ[ƒ“‚Éˆµ‚¤‚±‚Æ
  ‚ª‚Å‚«‚é:

  open(FH, "<", $path) or die "can't open $path: $!";

   ‚Ü‚½APerl ‚ÌƒŠƒŠ[ƒX 5.6 ‚Å‚ÍAopen ŠÖ”‚ÅƒoƒCƒiƒŠƒ‚[ƒh‚ğw’è‚Å‚«‚é‚æ‚¤‚É‚È‚Á
  ‚Ä‚¢‚é‚Ì‚ÅA‚í‚´‚í‚´ binmode ŠÖ”‚ğ•Ê‚ÉŒÄ‚Ño‚³‚¸‚ÉÏ‚ŞB$mode ˆø”‚Ìˆê•”‚Æ‚µ‚ÄA
  íX‚Ì“ü—ÍƒfƒBƒVƒvƒŠƒ“‚Æo—ÍƒfƒBƒVƒvƒŠƒ“‚ğw’è‚·‚é‚±‚Æ‚ª‚Å‚«‚é(3ˆø”‚Ìê‡‚Ì‚İ)B
  binmode ‚Æ“™‰¿‚È‚±‚Æ‚ğ‚·‚é‚É‚ÍA3ˆø”‚Ì open ‚ğg‚Á‚ÄA‘¼‚Ì $mode •¶š‚ÌŒã‚ë‚É
  :raw ƒfƒBƒVƒvƒŠƒ“‚ğw’è‚·‚ê‚Î‚æ‚¢:
  ...
  ƒfƒBƒVƒvƒŠƒ“    ˆÓ–¡
  -------------------------------------------------
  :raw            ƒoƒCƒiƒŠƒ‚[ƒhA‰½‚àè‚ğ‰Á‚¦‚È‚¢
  :crlf           ‰üs•¶š‚ğ”»•Ê‚·‚é
  :encoding(...)  ƒGƒ“ƒR[ƒfƒBƒ“ƒO–¼‚ğw’è‚·‚é
  -------------------------------------------------

   (‚»‚¤‚·‚é‚±‚Æ‚ÉˆÓ–¡‚ª‚ ‚é‚È‚ç‚Î)ƒfƒBƒVƒvƒŠƒ“‚ğÏ‚İd‚Ë‚é‚±‚Æ‚à‚Å‚«‚éB—á‚¦‚ÎAŸ
  ‚Ì‚æ‚¤‚Èw’è‚à‰Â”\‚Å‚ ‚é:
...
=item * chdir
    ...
    perl5.008001ˆÈ~, perl5.010, perl5.012 ‚É‚Ä•¶šƒR[ƒh(0x5C)‚ÅI‚í‚éƒfƒBƒŒ
    ƒNƒgƒŠ‚ğw’è‚µ‚ÄÀs‚·‚é‚Æ‚«AWin32 ƒ‚ƒWƒ…[ƒ‹‚Ì Win32::GetShortPathName()
    ‚É‚æ‚Á‚Ä’Z‚¢–¼‘O‚ğæ“¾‚Å‚«‚½ê‡‚Í chdir() ‚ª¬Œ÷‚µ‚Ü‚·B‚½‚¾‚µAchdir()
    Œã‚ÌƒJƒŒƒ“ƒgƒfƒBƒŒƒNƒgƒŠ‚Í Win32::GetShortPathName() ‚É‚æ‚Á‚Äæ“¾‚µ‚½’Z‚¢
    –¼‘O‚É‚È‚è‚Ü‚·B
...
(–M–ó ƒvƒƒOƒ‰ƒ~ƒ“ƒOPerl ‘æ3”Å) ‚Ì402ƒy[ƒW‚ğ‚à‚¤ˆê“xˆø—p‚µ‚Ü‚µ‚å‚¤B
  ...
  Sjisƒ\ƒtƒgƒEƒFƒA—˜—p‚É‚æ‚éî•ñˆ—ƒ‚ƒfƒ‹
    ...
    +-----------------------------------+
    |            ƒIƒNƒeƒbƒg—ñ           | ƒoƒCƒiƒŠƒf[ƒ^
    +-----------------------------------+
    |               •¶š—ñ              | ƒeƒLƒXƒgƒf[ƒ^
    +-----------------------------------+
    |       ASCII ŒİŠ·‚Ì•„†‰»•û®      | ShiftJIS ‚È‚Ç
    +-----------------------------------+
              (UTF8ƒtƒ‰ƒO‚ª‚È‚¢)
...
=item * ƒS[ƒ‹5
    ...
    ‚ ‚é‚¢‚Í MacJPerl ƒ†[ƒU‚ª MacPerl ‚Å MacJPerl ‚ğ•Ûç‚Å‚«‚é‚æ‚¤‚É‚È‚éB
...
‚³‚ê‚Ü‚µ‚½B‘S‚Ä‚Ì•û‚ÉŠ´Ó‚¢‚½‚µ‚Ü‚·B
 ...
 Chuck Houpt, –ì’Ã ”ü’qq‚³‚ñ, MacJPerl
