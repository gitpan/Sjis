...
‚±‚Ìƒ\ƒtƒgƒEƒFƒA‚ÍˆÈ‰º‚Ì“Á’¥‚ª‚ ‚è‚Ü‚·B
  ...
  * ShiftJIS ‚»‚Ì‚Ü‚Ü‚Ì’l‚ðˆµ‚¤

  * ‰ß‹Ž‚ÆŒ»Ý‚ÌƒXƒNƒŠƒvƒgŠÔ‚ÅƒR[ƒhAƒmƒEƒnƒE‚ð‹¤—L‚Å‚«‚é

  * UTF8 ƒtƒ‰ƒO‚ðˆµ‚í‚È‚¢‚Å‚·‚Þ

  * ‚Å‚à Perl5 ‚Æ‚ÍŒÝŠ·«‚ª‚ ‚é (‚Í‚¸‚¾)

  * (JPerl‚ð•ÛŽç‚·‚é‚½‚ß‚É) C ƒvƒƒOƒ‰ƒ~ƒ“ƒO‚ðs‚í‚È‚¢‚Å‚·‚Þ
...
‚±‚Ìƒ\ƒtƒgƒEƒFƒA‚É‚æ‚Á‚Ä‘‚«Š·‚í‚éŠÖ”‚ª‚ ‚è‚Ü‚·B
  ...
  * ƒVƒ“ƒOƒ‹ƒNƒH[ƒg’†‚Ì2ƒIƒNƒeƒbƒgƒR[ƒh•¶Žš—ñ‚Ìˆµ‚¢

  * ƒ_ƒuƒ‹ƒNƒH[ƒg’†‚Ì2ƒIƒNƒeƒbƒgƒR[ƒh•¶Žš—ñ‚Ìˆµ‚¢

  * ƒVƒ“ƒOƒ‹ƒNƒH[ƒg’†‚Ì2ƒIƒNƒeƒbƒgƒR[ƒh³‹K•\Œ»‚Ìˆµ‚¢

  * ƒ_ƒuƒ‹ƒNƒH[ƒg’†‚Ì2ƒIƒNƒeƒbƒgƒR[ƒh³‹K•\Œ»‚Ìˆµ‚¢

  * chop ‚Í Esjis::chop ‚É‘‚«Š·‚í‚è‚Ü‚·

  * split ‚Í Esjis::split ‚É‘‚«Š·‚í‚è‚Ü‚·

  * length ‚Í‚»‚Ì‚Ü‚Ü‚Å‚·

  * substr ‚Í‚»‚Ì‚Ü‚Ü‚Å‚·

  * index ‚Í Esjis::index ‚É‘‚«Š·‚í‚è‚Ü‚·

  * rindex ‚Í Esjis::rindex ‚É‘‚«Š·‚í‚è‚Ü‚·

  * pos ‚Í‚»‚Ì‚Ü‚Ü‚Å‚·

  * lc ‚Í Esjis::lc ‚Ü‚½‚Í Esjis::lc_ ‚É‘‚«Š·‚í‚è‚Ü‚·

  * uc ‚Í Esjis::uc ‚Ü‚½‚Í Esjis::uc_ ‚É‘‚«Š·‚í‚è‚Ü‚·

  * ord ‚Í‚»‚Ì‚Ü‚Ü‚Å‚·(ƒCƒ“ƒ|[ƒg‚µ‚È‚¢ê‡)

  * reverse ‚Í‚»‚Ì‚Ü‚Ü‚Å‚·(ƒCƒ“ƒ|[ƒg‚µ‚È‚¢ê‡)

  * tr/// ‚Ü‚½‚Í y/// ‚Í Esjis::tr ‚É‘‚«Š·‚í‚è‚Ü‚·

    /b ‚Æ /B CüŽq‚ª—˜—p‚Å‚«‚Ü‚·B

  * chdir ‚Í Esjis::chdir ‚É‘‚«Š·‚í‚è‚Ü‚·

    MSWin32 ŠÂ‹«‚Ìê‡‚Í perl5.005 ‚ÉŒÀ‚è•¶ŽšƒR[ƒh(0x5C)‚ÅI‚í‚éƒpƒX‚ðˆµ‚¤‚±‚Æ
    ‚ª‚Å‚«‚Ü‚·B

  * do file ‚Í Esjis::do file ‚É‘‚«Š·‚í‚è‚Ü‚·

  * require ‚Í Esjis::require ‚É‘‚«Š·‚í‚è‚Ü‚·

  * use Perl::Module @list; ‚Í
...
ˆÈ‰º‚Ì‹@”\‚Í JPerl ‚ÆãˆÊŒÝŠ·‚Å‚·B
  ...
  * chr ‚Í Esjis::chr ‚Ü‚½‚Í Esjis::chr_ ‚É‘‚«Š·‚í‚è‚Ü‚·

    2ƒIƒNƒeƒbƒgƒR[ƒh‚É‘Î‰ž‚µ‚Ä‚¢‚Ü‚·B

  * -X (ƒtƒ@ƒCƒ‹ƒeƒXƒg‰‰ŽZŽq) ‚Í Esjis::X ‚Ü‚½‚Í Esjis::X_ ‚É‘‚«Š·‚í‚è‚Ü‚·

    —á‚¦‚Î“ÇŽæ‚è‰Â”\‚©‚Ç‚¤‚©‚ðƒeƒXƒg‚·‚é -r ‚Í Esjis::r ‚É‚È‚è‚Ü‚·B

    MSWin32 ŠÂ‹«‚É‚Ä•¶ŽšƒR[ƒh(0x5C)‚ÅI‚í‚éƒpƒX‚ðˆµ‚¤‚±‚Æ‚ª‚Å‚«‚Ü‚·B

  * glob ‚Í Esjis::glob ‚Ü‚½‚Í Esjis::glob_ ‚É‘‚«Š·‚í‚è‚Ü‚·
  ...
  * lstat ‚Í Esjis::lstat ‚Ü‚½‚Í Esjis::lstat_ ‚É‘‚«Š·‚í‚è‚Ü‚·

    MSWin32 ŠÂ‹«‚É‚Ä•¶ŽšƒR[ƒh(0x5C)‚ÅI‚í‚éƒpƒX‚ðˆµ‚¤‚±‚Æ‚ª‚Å‚«‚Ü‚·B

  * opendir ‚Í Esjis::opendir ‚É‘‚«Š·‚í‚è‚Ü‚·

    MSWin32 ŠÂ‹«‚É‚Ä•¶ŽšƒR[ƒh(0x5C)‚ÅI‚í‚éƒpƒX‚ðˆµ‚¤‚±‚Æ‚ª‚Å‚«‚Ü‚·B

  * stat ‚Í Esjis::stat ‚Ü‚½‚Í Esjis::stat_ ‚É‘‚«Š·‚í‚è‚Ü‚·

    MSWin32 ŠÂ‹«‚É‚Ä•¶ŽšƒR[ƒh(0x5C)‚ÅI‚í‚éƒpƒX‚ðˆµ‚¤‚±‚Æ‚ª‚Å‚«‚Ü‚·B

  * unlink ‚Í Esjis::unlink ‚É‘‚«Š·‚í‚è‚Ü‚·

    MSWin32 ŠÂ‹«‚É‚Ä•¶ŽšƒR[ƒh(0x5C)‚ÅI‚í‚éƒpƒX‚ðˆµ‚¤‚±‚Æ‚ª‚Å‚«‚Ü‚·B

•¶ŽšŽwŒü‚ÌŠÖ”

  * ord ‚Í Sjis::ord ‚Ü‚½‚Í Sjis::ord_ ‚É‘‚«Š·‚í‚è‚Ü‚·
  ...
  * reverse ‚Í Sjis::reverse ‚É‘‚«Š·‚í‚è‚Ü‚·
...
ƒoƒO•ñAƒpƒbƒ`‚ðŠ½Œ}‚µ‚Ü‚·B
  ...
  * m/$re/o, s/$re/foo/o, qr/$re/o ‚Ì /o CüŽq

    Microsoft Windows Vista SP1 ã‚Ì perl5.010 ‚É‚Ä /o CüŽq‚ªŠú‘Ò’Ê‚è‚Ì“®ì‚ð‚µ
    ‚Ü‚¹‚ñ‚Å‚µ‚½B•Ï” $re ‚Ì’l‚ª•ÏX‚³‚ê‚é‚ÆŽŸ‰ñ‚ÌŽÀsŽž‚É‚»‚Ì•ÏX‚ª”½‰f‚³‚ê‚Ü‚·B

  * ³‹K•\Œ»“à‚ÌƒGƒXƒP[ƒv•¶Žš \b ‚Æ \B
...
ƒVƒtƒgJISƒR[ƒh‚Æ‚Í(“ú–{Œêî•ñˆ—‚æ‚è)
...
ƒEƒBƒLƒyƒfƒBƒA‚É‚æ‚éuShift_JISv‚Ì’è‹`
