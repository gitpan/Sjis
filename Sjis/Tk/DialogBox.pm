package Sjis::Tk::DialogBox;
######################################################################
#
# Sjis::Tk::DialogBox - Tk DialogBox widget for ShiftJIS script
#
...
# was: $VERSION = '4.015'; # was: sprintf '4.%03d', q$Revision: #13 $ =~ /\D(\d+)\s*$/;
...
sub Show {
    ...
    &$old_focus;
    &$old_grab;
    return Sjis::Encode::cp932($cw->{'selected_button'});
}
